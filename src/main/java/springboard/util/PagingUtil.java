	...
	public static String pagingImg(
			...
			*/
			...
			if(intTemp != 1) {
				...
				//두번째 페이지 블럭부터 출력됨.
				pagingStr += ""
					+ "<li class='page-item'><a href='"+page+"nowPage=1'>"
					+ "<i class='bi bi-skip-backward-fill'></i></a></li>";

				pagingStr += ""
					+ "<li class='page-item'><a href='"+page+"nowPage="+
									(intTemp-blockPage)+"'>"
			...
			*/
			...
			{
				if(intTemp==nowPage) {
					pagingStr += "<li class='page-item active'>"+intTemp+"</li>";
				}
				else {
					pagingStr += "<li class='page-item'><a href='"+page
						+"nowPage="+intTemp+"'>"+
						intTemp+"</a></li>";
				}
				intTemp++;
			...
			if(intTemp <= totalPage) {
				pagingStr += "<li class='page-item'><a href='"+page+"nowPage="+
												intTemp+"'>"
